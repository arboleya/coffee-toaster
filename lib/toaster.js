(function() {
  ...
  pkg('toaster.utils').FsUtil = FsUtil = (function() {
    ...
    FsUtil.mkdir_p = function(folderpath) {
      var folder, folders, index, _i, _len, _results;
  ...
  pkg('toaster.core').Module = Module = (function() {
    ...
    Module.prototype.watch = function() {
      ...
      return FsUtil.watch_folder(this.src, /.coffee$/, function(info) {
        ...
        if (info.action !== "watching") {
          return _this.toaster.builder.build();
        }
      });
    };
    ...
    Module.prototype.compile_for_debug = function(release_path) {
      var absolute_path, file, files, folder_path, index, relative_path, _i, _len, _ref;
  ...
  pkg('toaster').Config = Config = (function() {
    ...
    Config.prototype.src = function(dirpath) {
      if (this.root_src == null) {
        this.root_src = pn("" + this.basepath + "/" + dirpath + "/");
        if (!path.existsSync(this.root_src)) {
    ...
    Config.prototype.module = function(name, params) {
      ...
      params.name = name;
      params.src = this.root_src;
      if (!path.existsSync(pn("" + this.root_src + name))) {
        error(("Inexistent path informed for module " + name.red + ":\n") + ("\t" + this.root_src + name).red + "\n" + ("Check your " + 'toaster.coffee'.yellow + " and try again.") + "\n\t" + pn("" + this.basepath + "/toaster.coffee").yellow);
        return process.exit();
      }
      params.bare = (_ref = params.bare) != null ? _ref : false;
      params.packaging = (_ref1 = params.packaging) != null ? _ref1 : true;
      params.expose = ((_ref2 = params.expose === void 0) != null ? _ref2 : null) ? void 0 : params.expose;
      params.minify = (_ref3 = params.minify) != null ? _ref3 : false;
    ...
    Config.prototype.build = function(name, params) {
      ...
      params.webroot = (_ref1 = params.webroot) != null ? _ref1 : "";
  ...
  pkg('toaster.core').Builder = Builder = (function() {
    ...
    Builder.prototype.build = function() {
      var build, builds, contents, declaration, f, files, helper, i, include, mod, module, modules, name, namespaces, release_path, tmpl, vendors, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _results;
        ...
        if (this.opts.argv.d) {
          ...
          if (this.opts.argv.d) {
            for (i = _k = 0, _len2 = files.length; _k < _len2; i = ++_k) {
              ...
              tmpl = this.include_tmpl.replace("%SRC%", include);
              files[i] = tmpl;
            }
    ...
    Builder.prototype.unify_vendors = function(modules) {
      var mod, module, unique, vendor, _i, _j, _len, _len1, _ref;
      unique = [];
      ...
      for (_i = 0, _len = vendors.length; _i < _len; _i++) {
        ...
        if ((vendor = this.toaster.config.vendors[vendor_name]) != null) {
          if (path.existsSync(vendor)) {
            ...
            warn("Vendor ".white + vendor_name.yellow.bold + " not found at ".white + vendor.yellow.bold);
          }
        } else {
          warn("Vendor ".white + vendor_name.yellow.bold + " not informed in 'toaster.coffee'.");
        }
      }
      return buffer.join("\n");
    };
  ...
  pkg('toaster.generators').Config = Config = (function(_super) {
    ...
    Config.prototype.create = function(folderpath) {
      ...
      return this.ask(q1.magenta, /.+/, function(src) {
        return _this.ask(q2.cyan, /.+/, function(module) {
          return _this.ask(q3.magenta, /.+/, function(release) {
            return _this.ask(q4.cyan, /.*/, function(webroot) {
              return _this.write(src, module, release, webroot);
            });
          });
        });
      });
    ...
    Config.prototype.write = function(src, module, release, webroot) {
  ...
  pkg('toaster.generators').Project = Project = (function(_super) {
    ...
    Project.prototype.create = function(folderpath, name, src, release) {
      var default_name, q1, q2, q3, q4, target,
        _this = this;
        ...
        return _this.ask(q2.cyan, /.*/, function(module) {
          return _this.ask(q3.magenta, /.*/, function(release) {
            return _this.ask(q4.cyan, /.*/, function(webroot) {
              ...
              _this.scaffold(target, src, module, release, webroot);
              return process.exit();
            });
          });
        });
    ...
    Project.prototype.scaffold = function(target, src, module, release, webroot) {
      var moduledir, releasedir, releasefile, srcdir, vendorsdir;
      ...
      return new Config(target).write(srcdir, module, releasefile, webroot);
    };
