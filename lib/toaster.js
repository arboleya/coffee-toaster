  ...
  Script = (function() {
    ...
    Script.prototype.compile = function(cb) {
      return this.collect(__bind(function(files) {
        var buffer, classes, contents, file, filepath, folderpath, i, index, line, linenum, msg, obj, ordered, pkg, pkg_buffer, pkg_helper, processed, relative, root_packages, tmpl, toaster, _i, _j, _len, _len2, _len3, _len4;
    ...
    Script.prototype.collect = function(cb) {
      return FsUtil.find(this.src, "*.coffee", __bind(function(files) {
        var buffer, classname, classpath, dependencies, file, filefolder, filename, filepath, item, namespace, raw, repl, requirements, _i, _j, _len, _len2;
        buffer = [];
        for (_i = 0, _len = files.length; _i < _len; _i++) {
          file = files[_i];
      ...
      for (i = 0, _len = classes.length; i < _len; i++) {
        ...
        for (index = 0, _len2 = _ref.length; index < _len2; index++) {
          ...
          if (found != null) {
            ...
            klass.dependencies.splice(index, 1);
            console.log("WARNING! ".bold.yellow, "Dependency " + dependency.yellow.bold + " not found", "for class " + klass.classpath.yellow.bold + ".");
          }
        }
      }
      return classes;
