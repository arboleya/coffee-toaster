(function() {
  ...
  Toaster = (function() {
    ...
    Toaster.prototype.vendors = [];
    Toaster.prototype.builds = [];
    function Toaster() {
    ...
    Toaster.prototype.build_all = function() {
      if (this.builds != null) {
        return this.builder.join(this.modules, this.builds);
      }
    };
    Toaster.prototype.module = function(name, params) {
      params.name = name;
      params.src = pn("" + this.basepath + "/" + params.src);
      params.release = pn("" + this.basepath + "/" + params.release);
      return this.modules.push(params);
    };
    Toaster.prototype.vendor = function(name, params) {
      params.name = name;
      params.src = pn("" + this.basepath + "/" + params.src);
      return this.vendors.push(params);
    };
    Toaster.prototype.build = function(name, params) {
      params.name = name;
      params.release = pn("" + this.basepath + "/" + params.release);
      return this.builds.push(params);
    };
    Toaster.prototype.compile_andor_watch = function() {
      var build, filepath, module, vendor, _i, _len, _ref, _results;
      module = this.module;
      vendor = this.vendor;
      build = this.build;
