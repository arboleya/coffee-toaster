(function() {
  ...
  exports.FsUtil = pkg('toaster.utils').FsUtil = FsUtil = (function() {
    ...
    FsUtil.find = function(folderpath, pattern) {
    ...
    FsUtil.watch_folder = function(folderpath, filter_regexp, onchange, dispatch_create) {
      ...
      return fs.watchFile(folderpath, {
        ...
        var a, b, diff, info, item, snapshot, _j, _len1;
  ...
  exports.StringUtil = pkg('toaster.utils').StringUtil = StringUtil = (function() {
  ...
  pkg('toaster.core').Builder = Builder = (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (_j = 0, _len1 = result.length; _j < _len1; _j++) {
            ...
            if (include) {
              s = new Script(this, fpath, file, falias, this.cli, this.bare);
    ...
    Builder.prototype.build = function(header_code, footer_code) {
      ...
      contents = [vendors, helper, namespaces, header_code, this.compile(), footer_code].join('\n');
      if (this.minify) {
      ...
      if (this.cli.argv.d && (this.debug != null)) {
        ...
        contents = [vendors, helper, namespaces, header_code, files.join("\n", footer_code)];
        fs.writeFileSync(this.debug, contents.join("\n"));
        now = new Date();
        now = "" + (now.getHours()) + ":" + (now.getMinutes()) + ":" + (now.getSeconds());
  ...
  pkg('toaster').Toast = Toast = (function() {
    ...
    function Toast(toaster, config, after_toast) {
      var code, contents, filepath, fix_scope;
      this.toaster = toaster;
      this.after_toast = after_toast;
      ...
      if (path.existsSync(filepath) || (contents != null)) {
    ...
    Toast.prototype.toast = function(srcpath, params) {
      ...
      return this.builders.push(new Builder(this.toaster, this.toaster.cli, config));
    };
  ...
  exports.Toaster = Toaster = (function() {
    ...
    function Toaster(basedir, config, options, skip_initial_build) {
      var contents, filepath, k, schema, v;
      ...
      if (this.cli.argv.v) {
        ...
        this.toast = new toaster.Toast(this, config);
