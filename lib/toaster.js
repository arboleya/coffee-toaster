(function() {
  ...
  pkg('toaster.core').Builder = Builder = (function() {
    ...
    function Builder(toaster, config, opts) {
      ...
      this.exclude = (_ref5 = this.config.exclude) != null ? _ref5 : this.opts.argv.exclude;
    ...
    Builder.prototype.init = function() {
      ...
      return FsUtil.find(this.src, "*.coffee", function(result) {
        var file, include, item, _i, _j, _len, _len1, _ref;
  ...
  pkg('toaster.core').Script = Script = (function() {
    ...
    function Script(builder, realpath, opts) {
    ...
    Script.prototype.getinfo = function() {
      ...
      this.baseclasses = [];
      this.filepath = this.realpath.replace(this.builder.src, "").substr(1);
  ...
  pkg('toaster').Toast = Toast = (function() {
    ...
    Toast.prototype.toast = function(srcpath, params) {
      ...
      this.exclude = (_ref1 = params.exclude) != null ? _ref1 : [];
      this.bare = (_ref2 = params.bare) != null ? _ref2 : false;
      this.packaging = (_ref3 = params.packaging) != null ? _ref3 : true;
      this.expose = ((_ref4 = params.expose === void 0) != null ? _ref4 : null) ? void 0 : params.expose;
      this.minify = (_ref5 = params.minify) != null ? _ref5 : false;
      this.httpfolder = (_ref6 = params.httpfolder) != null ? _ref6 : "";
