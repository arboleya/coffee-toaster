(function() {
  var ArrayUtil, Config, Css, FsUtil, Kup, Project, Question, Script, StringUtil, Toaster, coffee, colors, cs, exec, fs, path, pn;
  ...
  Project = (function() {
    ...
    Project.prototype.create = function(argv) {
      var action, question1, question2, question3, target, _ref;
  ...
  Toaster = (function() {
    function Toaster() {
      ...
      if (argv.length && argv[0] === "new") {
        new Project(this.basepath).create(argv);
      } else {
        if (argv.length) {
