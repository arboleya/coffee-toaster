...
(function() {
  ...
  __t('toaster.core').Builder = (function() {
    ...
    function Builder(toaster, cli, config) {
      ...
      this.os_fs_change = __bind(this.os_fs_change, this);
    ...
    Builder.prototype.watch = function() {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        watcher.on('created', FnUtil.proxy(this.os_fs_change, src, 'created'));
        watcher.on('updated', FnUtil.proxy(this.os_fs_change, src, 'updated'));
        _results.push(watcher.on('deleted', FnUtil.proxy(this.os_fs_change, src, 'deleted')));
      }
      return _results;
    };

    Builder.prototype.os_fs_change = function(src, ev, f) {
      ...
      switch (ev) {
        case "created":
          if (f.type === "file") {
            s = new Script(this, fpath, f.location, falias, this.cli);
            this.files.push(s);
          }
