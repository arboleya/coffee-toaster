...
(function() {
  var FsUtil, StringUtil, Toaster, debug, error, growl, icon_error, icon_warn, interval, log, msgs, process_msgs, queue_msg, start_worker, stop_worker, warn,
    __slice = [].slice,
  ...
  exports.StringUtil = StringUtil = (function() {
