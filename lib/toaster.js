...
(function() {
  var Toaster, debug, error, exec, fs, growl, icon_error, icon_warn, interval, log, msgs, path, process_msgs, queue_msg, start_worker, stop_worker, warn,
  ...
  __t('toaster').Toast = (function() {
    ...
    Toast.prototype.toast = function(srcpath, params) {
      var alias, config, debug, folder, i, item, v, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (params == null) {
        params = {};
      }
  ...
  __t('toaster.core').Script = (function() {
    ...
    Script.prototype.getinfo = function(declare_ns) {
      var baseclass, decl, item, klass, name, requirements, rgx, rgx_ext, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _results;
      if (declare_ns == null) {
        declare_ns = true;
      }
      ...
      if (this.raw.match(rgx) != null) {
        if (this.namespace !== "" && this.builder.packaging) {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            this.raw = this.raw.replace(decl, "class " + this.namespace + "." + name);
  ...
  __t('toaster').Cli = (function() {
    ...
    function Cli() {
      ...
      this.argv = (this.opts = optimist.usage(usage).alias('n', 'new').describe('n', "Scaffold a very basic new App").alias('i', 'init').describe('i', "Create a config (toaster.coffee) file").alias('w', 'watch').describe('w', "Start watching/compiling your project").alias('c', 'compile').describe('c', "Compile the entire project, without watching it.").alias('d', 'debug').describe('d', 'Debug mode (compile js files individually)').alias('j', 'config').string('j').describe('j', "Config file formatted as a json-string.").alias('f', 'config-file').string('f').describe('f', "Path to a different config file.").alias('ns', 'inject-ns').describe('ns', "Inject namespace declarations for all project classes.").alias('v', 'version').describe('v', '').alias('h', 'help').describe('h', '')).argv;
    }
  ...
  __t('toaster.core').Builder = (function() {
    var ArrayUtil, FnUtil, FsUtil, Script, StringUtil, cs, fs, missing, path, uglify, uglify_parser, _ref;
    ...
    _ref = toaster.utils, FnUtil = _ref.FnUtil, FsUtil = _ref.FsUtil, ArrayUtil = _ref.ArrayUtil, StringUtil = _ref.StringUtil;
    ...
    Builder.prototype.build = function(header_code, footer_code) {
      var ast, c, contents, f, files, i, include, namespaces, now, tmpl, vendors, _i, _len;
      if (header_code == null) {
        header_code = "";
      }
      if (footer_code == null) {
    ...
    Builder.prototype.build_ns_tree = function(tree, folderpath) {
      var folder, folders, _i, _len, _results;
    ...
    Builder.prototype.watch = function() {
      var src, _i, _len, _ref1, _results,
        _this = this;
      _ref1 = this.config.src_folders;
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
