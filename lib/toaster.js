(function() {
  ...
  pkg('toaster.utils').FsUtil = FsUtil = (function() {
    ...
    FsUtil.find = function(folderpath, pattern, fn) {
      var _this = this;
      return exec("find -L " + folderpath + " -name '" + pattern + "'", function(error, stdout, stderr) {
  ...
  pkg('toaster.core').Builder = Builder = (function() {
    ...
    function Builder(configer, cli, config) {
      ...
      this.bare = (_ref1 = this.config.bare) != null ? _ref1 : this.cli.argv.bare;
      this.packaging = (_ref2 = this.config.packaging) != null ? _ref2 : this.cli.argv.packaging;
      this.expose = (_ref3 = this.config.expose) != null ? _ref3 : this.cli.argv.expose;
      this.minify = (_ref4 = this.config.minify) != null ? _ref4 : this.cli.argv.minify;
      this.exclude = [].concat((_ref5 = this.config.exclude) != null ? _ref5 : this.cli.argv.exclude);
      this.httpfolder = (_ref6 = this.config.httpfolder) != null ? _ref6 : '';
    ...
    Builder.prototype.init = function(after_init) {
      ...
      folder_num = this.config.src_folders.length;
        ...
        _results.push(FsUtil.find(folder.path, "*.coffee", FnUtil.proxy(function(folder, result) {
          ...
          for (_j = 0, _len1 = result.length; _j < _len1; _j++) {
            ...
            for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
              ...
              console.log("reg: " + new RegExp(item));
              console.log("include? " + !(new RegExp(item).test(file)));
    ...
    Builder.prototype.build = function(after_build) {
      var _this = this;
      if (this.config.is_building === true) {
        return;
      }
      this.config.is_building = true;
      return this.build_namespaces(function(namespaces) {
        ...
        _this.config.is_building = false;
  ...
  pkg('toaster').Toast = Toast = (function() {
    ...
    Toast.prototype.toast = function(srcpath, params) {
      var alias, config, folder, item, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      if (params == null) {
        params = {};
      }
      ...
      config = {
        ...
        expose: ((_ref4 = params.expose === void 0) != null ? _ref4 : null) ? void 0 : params.expose,
        minify: (_ref5 = params.minify) != null ? _ref5 : false,
        httpfolder: (_ref6 = params.httpfolder) != null ? _ref6 : "",
        release: pn("" + this.basepath + "/" + params.release),
        debug: pn("" + this.basepath + "/" + params.debug)
      };
      if (!(srcpath instanceof Object)) {
      ...
      return new Builder(this.toaster, this.toaster.cli, config);
    };
