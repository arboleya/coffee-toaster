(function() {
  var ArrayUtil, Config, Css, FsUtil, Kup, Parser, Project, Question, Script, StringUtil, Toaster, argv, colors, cs, exec, fs, optimist, opts, path, pkg, pn, toaster;
  ...
  pkg('toaster.grains').Script = Script = (function() {
    ...
    Script.prototype.reorder = function(files, cycling) {
      var bc, file, file_index, filepath, found, i, index, initd, not_found, _i, _len, _len2, _len3, _ref, _ref2;
      if (cycling == null) {
        cycling = false;
      }
      if (cycling === false) {
      ...
      for (i = 0, _len = files.length; i < _len; i++) {
        ...
        for (index = 0, _len2 = _ref.length; index < _len2; index++) {
          filepath = _ref[index];
          if (ArrayUtil.has(initd, filepath, "filepath")) {
            continue;
          }
