...
(function() {
  var Toaster, debug, error, exec, fs, log, path, warn,
  ...
  __t('toaster.utils').FsUtil = (function() {
    ...
    FsUtil.mkdir_p = function(folderpath) {
      var exists, folder, folders, fullpath, index, _i, _len;
      folderpath = path.resolve(folderpath);
      folders = folderpath.split(path.sep);
      if (path.sep === "\/") {
        folders.unshift(path.sep);
      }
      for (index = _i = 0, _len = folders.length; _i < _len; index = ++_i) {
        folder = folders[index];
        fullpath = path.join.apply(null, folders.slice(0, index + 1));
  ...
  error = function(msg, send_to_growl, file) {
    ...
    return msg = log("ERROR ".bold.red + msg);
  };
  ...
  warn = function(msg, send_to_growl) {
    ...
    return msg = log("WARNING ".bold.yellow + msg);
  };
    ...
    Script.prototype.expand_dependencies = function() {
      ...
      for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
        ...
        if (dependency.substr(-1) !== "*") {
          this.dependencies.push(path.resolve("" + dependency + ".coffee"));
          continue;
        }
    ...
    Builder.prototype.watch = function() {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        _results.push(FsUtil.watch_folder(src.path, /.coffee$/, FnUtil.proxy(function(src, info) {
          var falias, file, fpath, include, ipath, item, msg, now, relative_path, s, type, _j, _len1, _ref2;
          ...
          for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
            item = _ref2[_j];
            include &= !(new RegExp(item).test(ipath));
          }
          if (!include) {
            return;
          }
  ...
  __t('toaster.generators').Config = (function(_super) {
    ...
    Config.prototype.create = function(folderpath) {
      var q1, q2, q3,
        _this = this;
      this.basepath = path.resolve(folderpath);
