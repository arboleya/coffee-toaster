(function() {
  var ArrayUtil, Builder, Config, Css, FsUtil, Kup, Parser, Project, Question, Script, StringUtil, Toaster, argv, colors, cs, exec, fs, optimist, opts, path, pkg, pn, toaster;
  ...
  fs = require("fs");
  pn = path.normalize;
  exports.FsUtil = pkg('toaster.utils.fs-util.coffee').FsUtil = FsUtil = (function() {
    function FsUtil() {}
    FsUtil.snapshots = {};
  ...
  pkg('toaster.utils.string-util.coffee').StringUtil = StringUtil = (function() {
    function StringUtil() {}
  ...
  pkg('toaster.utils.array-util.coffee').ArrayUtil = ArrayUtil = (function() {
    function ArrayUtil() {}
  ...
  fs = require('fs');
  path = require('path');
  pkg('toaster').Builder = Builder = (function() {
    function Builder(toster) {
      this.toster = toster;
    }
    Builder.prototype.join = function(modules, builds) {
      var buffer, build, file, files, found, module, _i, _j, _k, _len, _len2, _len3, _ref, _results;
      _results = [];
      for (_i = 0, _len = builds.length; _i < _len; _i++) {
        ...
        _results.push(console.log("" + '.'.green + " " + build.release));
      }
      return _results;
    };
    return Builder;
  ...
  pkg('toaster.grains').Css = Css = (function() {
    function Css() {}
    return Css;
  })();
  pkg('toaster.grains').Kup = Kup = (function() {
    function Kup() {}
    return Kup;
  })();
  fs = require("fs");
  cs = require("coffee-script");
  pkg('toaster.grains').Script = Script = (function() {
    var missing;
    function Script(toaster, config, opts) {
    ...
    Script.prototype.compile = function(cb) {
      return this.collect(__bind(function(files) {
        var buffer, contents, expanded, file, filepath, folderpath, i, index, line, linenum, msg, obj, ordered, pkg, pkg_buffer, pkg_helper, relative, root_packages, tmpl, toaster_src, _i, _j, _len, _len2, _len3, _len4;
    ...
    Script.prototype.reorder = function(files, cycling) {
      var bc, dependency, dependency_index, file, file_index, filepath, found, i, index, not_found, _i, _len, _len2, _len3, _ref, _ref2;
      if (cycling == null) {
        cycling = false;
      }
      if (cycling === false) {
  ...
  Toaster = (function() {
    ...
    Toaster.prototype.build = function() {
      if (this.builds != null) {
        return this.builder.join(this.modules, this.builds);
      }
    };
    Toaster.prototype.compile_andor_watch = function() {
      var build, contents, filepath, module, _i, _j, _len, _len2, _ref, _ref2, _results;
      ...
      if (path.existsSync(filepath)) {
        ...
        eval(contents);
        this.modules = [].concat(typeof modules !== "undefined" && modules !== null ? modules : []);
        this.builds = [].concat(typeof builds !== "undefined" && builds !== null ? builds : []);
        _ref = this.builds;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          build = _ref[_i];
          build.release = pn("" + this.basepath + "/" + build.release);
        }
        _ref2 = this.modules;
        _results = [];
        for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
          ...
          _results.push(new Script(this, module, opts));
        }
        return _results;
      } else {
