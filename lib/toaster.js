(function() {
  ...
  pkg('toaster.core').Script = Script = (function() {
    ...
    Script.prototype.getinfo = function() {
      var baseclass, expose, item, klass, repl, requirements, rgx, rgx_ext, _i, _j, _len, _len2, _ref, _ref2, _results;
      ...
      if (this.raw.match(new RegExp(rgx, "m")) != null) {
        if (this.namespace !== "") {
          expose = this.module.expose;
          if (expose != null) {
            expose = "" + this.module.expose + ".$3 = ";
          } else {
            expose = "";
          }
          if (this.module.package) {
            repl = "$1pkg( '" + this.namespace + "' ).$3 = " + expose + " $2 $3";
  ...
  pkg('toaster.core').Module = Module = (function() {
    ...
    function Module(toaster, config, opts) {
      var expose, _ref, _ref2, _ref3, _ref4, _ref5, _ref6;
      this.toaster = toaster;
      this.config = config;
      this.opts = opts;
      ...
      this.package = (_ref5 = this.config.package) != null ? _ref5 : this.opts.argv.package;
      this.minify = (_ref6 = this.config.minify) != null ? _ref6 : this.opts.argv.minify;
      if (this.expose !== false) {
        expose = "" + this.expose + "[part] = ";
      } else {
        expose = "";
      }
      this.pkg_helper = this.pkg_helper.replace("%expose%", expose);
      this.files = [];
    ...
    Module.prototype.compile = function(include_vendors) {
      ...
      namespaces = this.package ? this.get_root_namespaces() : "";
