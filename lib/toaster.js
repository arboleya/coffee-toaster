(function() {
  ...
  exports.Project = Project = (function() {
    ...
    Project.prototype.create = function(folderpath, name, src, release) {
      ...
      if (!folderpath) {
        console.log(("" + 'Error'.bold.red + " You need to inform") + "a target path!".red);
      ...
      return this.ask(question1, /.+/, name, __bind(function(name) {
        return this.ask(question2, /.*/, src, __bind(function(src) {
          return this.ask(question3, /.*/, release, __bind(function(release) {
            this.scaffold(target, name, src, release);
            return process.exit();
          }, this));
        }, this));
      }, this));
  ...
  Toaster = (function() {
    function Toaster() {
      ...
      if (argv.n) {
        new Project(this.basepath).create(argv._[0]);
      } else if (argv.i) {
