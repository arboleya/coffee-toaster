(function() {
      ...
      exec("ls " + folderpath, __bind(function(error, stdout, stderr) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push(item.type === "folder" ? FsUtil.watch_folder(item.path, filter_regexp, onchange) : filter_regexp === null || filter_regexp.test(item.path) ? dispatch_create ? (onchange({
            ...
            path: item.path,
            action: "created"
          }), FsUtil.watch_file(item.path, onchange)) : void 0 : void 0);
        }
        return _results;
      }, this));
  ...
  pkg('toaster.core').Script = Script = (function() {
    ...
    Script.prototype.classname = null;
    Script.prototype.namespace = null;
    Script.prototype.classpath = null;
    Script.prototype.filepath = null;
    Script.prototype.filename = null;
    Script.prototype.filefolder = null;
    Script.prototype.baseclasses = [];
    Script.prototype.dependencies = [];
    Script.prototype.dependencies_collapsed = [];
  ...
  pkg('toaster.core').Builder = Builder = (function() {
    ...
    Builder.prototype.join = function(modules, builds) {
      var build, file, files, found, mods_buffer, module, _i, _j, _k, _len, _len2, _len3, _ref, _results;
      _results = [];
  ...
  pkg('toaster.core').Module = Module = (function() {
    var missing;
    Module.prototype.pkg_helper = "{root_namespaces}\npkg = ( ns )->\n	curr = null\n	parts = [].concat = ns.split( \".\" )\n	for part, index in parts\n		if curr == null\n			curr = eval part\n			continue\n		else\n			unless curr[ part ]?\n				curr = curr[ part ] = {}\n			else\n				curr = curr[ part ]\n	curr\n";
    Module.prototype.files = [];
    ...
    Module.prototype.watch = function() {
      return FsUtil.watch_folder(this.src, /.coffee$/, __bind(function(info) {
        ...
        if (info.action !== "watching") {
          return this.write(this.compile());
        }
      }, this));
    };
    Module.prototype.compile = function(include_vendors) {
      var compiled, file, k, namespaces_buffer, output, root_namespaces, v, vendor, vendor_name, vendors, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3;
      ...
      this.reorder();
      output = this.pkg_helper + ((function() {
      ...
      if (include_vendors) {
        ...
        for (_k = 0, _len3 = _ref3.length; _k < _len3; _k++) {
          vendor_name = _ref3[_k];
          if ((vendor = this.toaster.config.vendors[vendor_name])) {
  ...
  Toaster = (function() {
    ...
    function Toaster() {
      this.build = __bind(this.build, this);
      this.vendor = __bind(this.vendor, this);
      this.module = __bind(this.module, this);      this.parser = new Parser;
    ...
    Toaster.prototype.init_modules = function() {
      ...
      for (k in _ref) {
        v = _ref[k];
        _results.push(this.modules[module.name] = new Module(this, v, this.parser.opts));
      }
      return _results;
    };
    ...
    Toaster.prototype.vendor = function(name, src) {
      return this.vendors[name] = pn("" + this.basepath + "/" + src);
    };
